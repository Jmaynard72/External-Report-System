...
def send_message_with_attachment(toEmail:str, body_text:str,attachment_path:str):
    ...
    subject = "Payroll Solutions Report"

    body_text += """\n\n\n\nThis report is generated by Payroll Solutions Electronic Reporting System (ERS).  For questions concerning the format of the report, please email helpdesk@payrollsolutions.cc,
